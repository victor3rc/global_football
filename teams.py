...
BRAZIL = {1930: Squad(0, 0, 0, 22), 1934: Squad(0, 2, 0, 19), 1938: Squad(0, 0, 0, 22),
          ...
          1998: Squad(6, 13, 13, 22), 2002: Squad(2, 10, 10, 23)}
...
URUGUAY = {1930: Squad(0, 0, 0, 22), 1934: Squad(2, 0, 0, 0), 1950: Squad(0, 0, 0, 22),
           ...
           1990: Squad(0, 12, 9, 22), 2002: Squad(0, 15, 15, 23)}
...
PARAGUAY = {1930: Squad(0, 0, 0, 22), 1950: Squad(0, 0, 0, 22), 1958: Squad(0, 0, 0, 22),
            1986: Squad(0, 7, 1, 22), 1998: Squad(0, 19, 7, 22), 2002: Squad(0, 14, 0, 23)}
...
ECUADOR = {1998: Squad(1, 0, 0, 0), 2002: Squad(0, 3, 3, 23)}
...
COSTA_RICA = {1990: Squad(0, 0, 0, 22), 2002: Squad(0, 3, 3, 23)}
...
ENGLAND = {1950: Squad(1, 0, 0, 22), 1954: Squad(7, 0, 0, 22), 1958: Squad(35, 0, 0, 22),
           ...
           1998: Squad(52, 0, 0, 22), 2002: Squad(81, 1, 0, 23)}
...
TURKEY = {1954: Squad(0, 0, 0, 22), 1986: Squad(1, 0, 0, 0), 1994: Squad(2, 0, 0, 0),
          1998: Squad(18, 0, 0, 0), 2002: Squad(6, 10, 0, 23)}
...
GREECE = {1986: Squad(1, 0, 0, 0), 1990: Squad(1, 0, 0, 0), 1994: Squad(0, 0, 0, 22),
          1998: Squad(3, 0, 0, 0), 2002: Squad(10, 0, 0, 0)}
...
PORTUGAL = {1966: Squad(0, 0, 0, 22), 1974: Squad(1, 0, 0, 0), 1982: Squad(1, 0, 0, 0),
            ...
            1998: Squad(9, 0, 0, 0), 2002: Squad(5, 15, 0, 23)}
...
SWEDEN = {1934: Squad(0, 0, 0, 22), 1938: Squad(0, 0, 0, 22), 1950: Squad(0, 0, 0, 22),
          ...
          2002: Squad(1, 0, 0, 0), 2002: Squad(0, 20, 0, 23)}

POLAND = {1938: Squad(0, 0, 0, 22), 1974: Squad(0, 0, 0, 22), 1978: Squad(0, 1, 0, 22),
          1986: Squad(0, 4, 0, 22), 2002: Squad(0, 15, 0, 23)}
...
SCOTLAND = {1954: Squad(0, 7, 0, 22), 1958: Squad(2, 6, 0, 22), 1970: Squad(1, 0, 0, 0),
            ...
            1998: Squad(3, 10, 0, 22), 2002: Squad(7, 0, 0, 0)}
...
BULGARIA = {1962: Squad(0, 0, 0, 22), 1966: Squad(0, 0, 0, 22), 1970: Squad(0, 0, 0, 22),
            ...
            1998: Squad(0, 10, 0, 22), 2002: Squad(1, 0, 0, 0)}
ISRAEL = {1970: Squad(0, 0, 0, 22), 2002: Squad(2, 0, 0, 0)}
DENMARK = {1986: Squad(0, 15, 0, 22), 1994: Squad(2, 0, 0, 0), 1998: Squad(1, 16, 0, 22),
           2002: Squad(1, 20, 0, 23), 2002: Squad(4, 0, 0, 0)}
...
CROATIA = {1998: Squad(0, 12, 0, 22), 2002: Squad(0, 19, 0, 23)}
SLOVENIA = {2002: Squad(0, 18, 1, 23)}
UKRAINE = {2002: Squad(2, 0, 0, 0)}
...
CZECH_REPUBLIC = {2002: Squad(1, 0, 0, 0)}
...
IRAN = {1978: Squad(0, 0, 0, 22), 1998: Squad(0, 3, 3, 22)}
...
QATAR = {1994: Squad(1, 0, 0, 0), 2002: Squad(1, 0, 0, 0)}
SOUTH_AFRICA = {1998: Squad(1, 14, 14, 22), 2002: Squad(0, 16, 16, 23)}
CHINA = {1998: Squad(1, 0, 0, 0), 2002: Squad(1, 3, 3, 23)}
